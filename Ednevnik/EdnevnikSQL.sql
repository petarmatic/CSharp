...
insert into ocjene(ucenik_id,predmet_id,ocjena,datum) values(1,2,'5','2024-01-11 14:01');
insert into ocjene(ucenik_id,predmet_id,ocjena,datum) values(2,1,'3','2024-02-09 08:58');
insert into ocjene(ucenik_id,predmet_id,ocjena,datum) values(1,2,'5','2024-03-11 12:00');
